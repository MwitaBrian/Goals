...
export class GoalComponent implements OnInit {
  ...
  goals:Goal[] = [
    ...
    {id:2, name:'Watch Titanic',description:'I have to buy cookies for the parrot'},
    {id:3, name:'Buy Cookies', description:'I have to buy cookies for the parrot'},
    {id:4, name:'Get new Phone Case', description:'Diana has her birthday coming up soon'},
